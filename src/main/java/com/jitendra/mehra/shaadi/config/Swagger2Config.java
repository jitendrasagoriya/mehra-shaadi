...
import com.jitendra.mehra.shaadi.interceptor.InterceptLog;
...
public class Swagger2Config implements WebMvcConfigurer {
	...
	private ApiInfo apiInfoMetaData() {
		...
		return new ApiInfoBuilder().title("MEHRA SHAADI").description("API Endpoint Decoration")
				.contact(new Contact("Dev-Team", "", "jitendra.sagoriya.jio@gmail.com")).license("Apache 2.0")
				.licenseUrl("http://www.apache.org/licenses/LICENSE-2.0.html").version("2.0.0").build();
	}
